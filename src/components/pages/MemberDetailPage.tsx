...
const TikTokIcon = ({ className }: { className?: string }) => (
  <svg className={className} viewBox="0 0 24 24" fill="currentColor" stroke="none">
    <path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-5.2 1.74 2.89 2.89 0 0 1 2.31-4.64 2.93 2.93 0 0 1 .8.11v-3.5a6.39 6.39 0 0 0-3.11.8 6.34 6.34 0 0 0-3.31 5.3 6.35 6.35 0 0 0 5.4 6.35 6.37 6.37 0 0 0 7.23-5.24 6.42 6.42 0 0 0 .13-1.28V9.16a8.23 8.23 0 0 0 5.2 1.84V7.52a4.8 4.8 0 0 1-2.29-.83z"/>
  </svg>
);
